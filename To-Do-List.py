...
#B
button=tkinter.Button(f3,text="CREATE",width=20,fg="yellow",bg="black",padx=10)                               
button.grid(row=0,column=0,pady=10)
button.bind("<Button-1>",click)
#B
button=tkinter.Button(f3,text="UPDATE",width=20,fg="yellow",bg="black",padx=10)                               
button.grid(row=2,column=0,pady=10)
button.bind("<Button-1>",click)
#B
button=tkinter.Button(f3,text="DELETE",width=20,fg="yellow",bg="black",padx=10)                               
button.grid(row=3,column=0,pady=10)
button.bind("<Button-1>",click)
#B
button=tkinter.Button(f3,text="QUIT",width=20,fg="yellow",bg="green",padx=10,command=quit)                     
